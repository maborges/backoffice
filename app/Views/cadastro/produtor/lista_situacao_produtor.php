                ...
                <div class="card card-solidy shadow-sm">
                    <div class="card-header d-flex">
                        <div class="row col-md-12">
                            ...
                            <div class="form-group col-md-2 content-center align-self-end">

                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="ativo" id="checkAtivo" value="1" <?= $ativo == 1 ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="checkAtivo">Ativo</label>
                                </div>

                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="ativo" id="checkInativo" value="0" <?= $ativo == 0 ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="checkInativo">Inativo</label>
                                </div>
                            </div>
                    ...
                    <div class="card-body mt-0">
                        ...
                        <div class="card-body mt-1 pt-1 ">
                            <div class="row">
                                <table class="display compact" id="tblSituacaoProdutor" style="width: 100%; height: auto">
...
<script>
    $(document).ready(function() {
        var table = $('#tblSituacaoProdutor').DataTable({
            caption: '',
            deferRender: true,
            fixedHeader: true,
            scrollCollapse: true,
            ...
            serverSide: false,
            ajax: {
                url: "<?= base_url('cadastro/produtor_get_lista_situacao') ?>",
                type: "POST",
                data: function(d) {
                    d.produto = $('#produto').val();
                    d.produtor = $('#produtor').val();
                    d.ativo = $('input[name="ativo"]:checked').val()
                },
                ...
                error: function(xhr, status, error) {
                    ...
                    $('#tblSituacaoProdutor_processing').hide();
                    $('#tblSituacaoProdutor').DataTable().clear().draw();
                }
            },
            pageLength: 25,
            ...
            columns: [{
                ...
                },
                {
                    ...
                    className: 'dt-right',
                    render: function(data, type, row) {
                        var valorFormatado = parseInt(data).toLocaleString("pt-BR", {
