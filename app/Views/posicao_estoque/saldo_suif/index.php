            ...
            <div class="col-md-12">
                <div class="card card-solidy shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="col-12">
                            <div class="row">
                                <table class="display compact" id="tblSaldoSuif" style="width: 100%; height: auto">
                                    <thead class="table-light">
                                        <tr>
                                            <th>Data</th>
                                            <th>Saldo Acumulado</th>
                                            <th>Estoque SUIF</th>
                                            <th>Saldo Armazenado</th>
                                            <th>Saldo a Puxar</th>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#tblSaldoSuif').DataTable({
            /*
            ...
            */
            ...
            serverSide: false,
            ajax: {
                url: "<?= base_url('posicao_estoque/get_saldo_suif') ?>",
                type: "POST",
                data: function(d) {
                ...
                error: function(xhr, status, error) {
                    ...
                    $('#tblSaldoSuif_processing').hide();
                    $('#tblSaldoSuif').DataTable().clear().draw();
                }
            },
            pageLength: 25,
            columnDefs: [
            ...
            columns: [{
                ...
                {
                    data: 'estoque_total_suif'
                },
                {
                    data: 'armazenado_suif'
                },
                {
                    data: 'saldo_puxar'
                },
