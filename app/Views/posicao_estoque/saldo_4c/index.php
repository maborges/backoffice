            ...
            <div class="col-md-8">
                <div class="card card-solidy shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="col-12">
                            <div class="row">
                                <table class="display compact" id="tblSaldo4c" style="width: 100%; height: auto">
                                    <thead class="table-light">
                                        <tr>
                                            <th>Data</th>
                                            <th>Saldo Acumulado</th>
                                            <th>Estoque Fiscal</th>
                                            <th>Vendas 4C</th>
                                        </tr>
                                    </thead>
                                    <tbody>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#tblSaldo4c').DataTable({
            /*
            ...
            */
            ...
            serverSide: false,
            ajax: {
                url: "<?= base_url('posicao_estoque/get_saldo_4c') ?>",
                type: "POST",
                data: function(d) {
                ...
                error: function(xhr, status, error) {
                    ...
                    $('#tblSaldo4c_processing').hide();
                    $('#tblSaldo4c').DataTable().clear().draw();
                }
            },
            pageLength: 25,
            columnDefs: [{
